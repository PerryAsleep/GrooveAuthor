...
internal sealed class Receptor
{
	...
	private bool Held;
	private bool AutoplayHeld;

	// Animated values.
	private float BeatBrightness = 1.0f;
	private float TapScale = 1.0f;
	private float RimScale = 1.0f;
	private float RimAlpha;
	private float GlowAlpha;

	// Animation timers.
	private double TapAnimStartOffset;
	private Stopwatch TapAnimStopwatch;
	private double RimAnimStartOffset;
	private Stopwatch RimAnimStopwatch;
	private double GlowAnimStartOffset;
	private Stopwatch GlowAnimStopwatch;
	...
	/// </summary>
	/// <param name="focalPoint">The focal point of the receptor group.</param>
	/// <param name="sizeZoom">The current zoom level for sizing objects.</param>
	/// <param name="textureAtlas">TextureAtlas containing receptor images.</param>
	/// <param name="spriteBatch">SpriteBatch to use for rendering.</param>
	...
	private void UpdateBeatBrightness(bool playing, double chartPosition)
	{
		...
		if (playing && Preferences.Instance.PreferencesReceptors.PulseReceptorsWithTempo)
		{
			...
			BeatBrightness = Interpolation.Lerp(BeatAnimStartBrightness, BeatAnimEndBrightness, 0.0f, BeatAnimTimeEnd,
				percentageBetweenBeats);
		}
	}
