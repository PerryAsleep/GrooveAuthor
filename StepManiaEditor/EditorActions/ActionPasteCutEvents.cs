...
//{
//	internal class ActionPasteCutEvents : EditorAction
//	{
//		/// <summary>
...
//		private List<EditorEvent> TransformedEvents;
//		/// <summary>
...
//		public ActionPasteCutEvents(Editor editor, EditorChart chart, IEnumerable<EditorEvent> events, int row)
//		{
//			Editor = editor;
//			Chart = chart;
//			//Rows = rows;
...
//			{
//				PasteCutUntransformedEvents();
//			}
//			else
//			{
//				PasteCutTransformedEvents();
//			}
...
//		private void PasteCutUntransformedEvents()
//		{
...
//				// removing.
//				var eventTransformedTogether = newEvent.GetEventsSelectedTogether();
...
//		private void PasteCutTransformedEvents()
//		{
