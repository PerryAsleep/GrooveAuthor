...
float inverseRenderTargetWidth;
float inverseRenderTargetHeight;
...
/*--------------------------------------------------------------------------*/
    ...
    #define FxaaTexAlpha4(t, p) FxaaTexTop(tex, p).w

    //#define FxaaTexOffAlpha4(t, p, o) t.tex.GatherAlpha(t.smpl, p, o)
    #define FxaaTexOffAlpha4(t, p, o) FxaaTexOff(t, p, o, 1).w
    
    //#define FxaaTexGreen4(t, p) t.tex.GatherGreen(t.smpl, p)
    #define FxaaTexGreen4(t, p) FxaaTexTop(tex, p).y
    
    //#define FxaaTexOffGreen4(t, p, o) t.tex.GatherGreen(t.smpl, p, o)
    #define FxaaTexOffGreen4(t, p, o) FxaaTexOff(t, p, o, 1).y

    // Fumen modification end
...
FxaaFloat4 FxaaPixelShader(
    ...
    // {xy__} = upper left of pixel
    // {__zw} = lower right of pixel
    // Fumen modification: //FxaaFloat4 fxaaConsolePosPos,
    //
    // Input color texture.
    ...
    // Fumen modification: //FxaaTex fxaaConsole360TexExpBiasNegOne,
    //
    // Only used on the optimized 360 version of FXAA Console.
    // For everything but 360, just use the same input here as for "tex".
    // For 360, same texture, just alias with a 3nd sampler.
    // This sampler needs to have an exponent bias of -2.
    // Fumen modification: //FxaaTex fxaaConsole360TexExpBiasNegTwo,
    //
    ...
    // Fumen modification: //FxaaFloat4 fxaaConsoleRcpFrameOpt,
    //
    // Only used on FXAA Console.
    ...
    // Fumen modification: //FxaaFloat4 fxaaConsoleRcpFrameOpt2,
    //
    // Only used on FXAA Console.
    ...
    // Fumen modification: //FxaaFloat4 fxaaConsole360RcpFrameOpt2,
    //
    // Only used on FXAA Quality.
    ...
    FxaaFloat fxaaQualityEdgeThresholdMin// Fumen modification: //,
    // 
    // Only used on FXAA Console.
    ...
    // Fumen modification: //FxaaFloat fxaaConsoleEdgeSharpness,
    //
    // Only used on FXAA Console.
    ...
    //   0.25 leaves more aliasing, and is sharper
    // Fumen modification: //FxaaFloat fxaaConsoleEdgeThreshold,
    //
    // Only used on FXAA Console.
    ...
    //   Tune by looking at mostly non-green content,
    //   then start at zero and increase until aliasing is a problem.
    // Fumen modification: //FxaaFloat fxaaConsoleEdgeThresholdMin,
    //    
    ...
    // Fumen modification: //FxaaFloat4 fxaaConsole360ConstDir
) {
/*--------------------------------------------------------------------------*/
    FxaaFloat2 posM;
    posM.x = pos.x;
...
float4 PixelShaderFunction(float4 position : SV_Position, float4 color : COLOR0, float2 texCoords : TEXCOORD0) : SV_Target0
{
    float4 value = FxaaPixelShader(
        texCoords,
        renderTargetSampler,
        float2(inverseRenderTargetWidth, inverseRenderTargetHeight),
        fxaaQualitySubpix,
