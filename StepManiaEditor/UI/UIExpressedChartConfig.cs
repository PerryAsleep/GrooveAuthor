	...
	internal sealed class UIExpressedChartConfig
	{
		...
		public void Draw()
		{
			...
			if (ImGui.Begin("Expressed Chart Config", ref p.ShowExpressedChartListWindow, ImGuiWindowFlags.NoScrollbar))
			{
				...
				{
					ImGuiLayoutUtils.DrawRowTextInput(true, "Name", namedConfig, nameof(NamedConfig.Name), true, Preferences.Instance.PreferencesExpressedChartConfig.IsNewConfigNameValid,
						"Configuration name." +
					...
					ImGuiLayoutUtils.DrawRowEnum<BracketParsingMethod>(true, "Default Bracket Parsing Method", config, nameof(ExpressedChartConfig.DefaultBracketParsingMethod), false,
					...
					ImGuiLayoutUtils.DrawRowEnum<BracketParsingDetermination>(true, "Bracket Parsing Determination", config, nameof(ExpressedChartConfig.BracketParsingDetermination), false,
					...
					ImGuiLayoutUtils.DrawRowInputInt(true, "Min Level for Brackets", config, nameof(ExpressedChartConfig.MinLevelForBrackets), false,
					...
					ImGuiLayoutUtils.DrawRowCheckbox(true, "Aggressive Brackets When Unambiguous", config, nameof(ExpressedChartConfig.UseAggressiveBracketsWhenMoreSimultaneousNotesThanCanBeCoveredWithoutBrackets), false,
					...
					ImGuiLayoutUtils.DrawRowDragDouble(true, "Balanced Bracket Rate For Aggressive", config, nameof(ExpressedChartConfig.BalancedBracketsPerMinuteForAggressiveBrackets), false,
					...
					ImGuiLayoutUtils.DrawRowDragDouble(true, "Balanced Bracket Rate For No Brackets", config, nameof(ExpressedChartConfig.BalancedBracketsPerMinuteForNoBrackets), false,
						"When using Choose Method Dynamically for Bracket Parsing Determination, and the above" +
						"\nvalues have still not determined which Bracket Parsing Method to use, then the Chart" +
						"\nwill be parsed with the Balanced Bracket Parsing Method to determine the number of" +
