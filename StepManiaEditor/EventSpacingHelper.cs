...
internal abstract class EventSpacingHelper
{
	...
	/// </summary>
	/// <param name="rateEvent">The EditorRateAlteringEvent to use for determining the pps and ppr values.</param>
	...
	/// <param name="anchorRow">The row of the anchor event.</param>
	/// <returns>Tuple where the first value is the chart time and the second value is the row.</returns>
	public abstract (double, double) GetChartTimeAndRowFromPreviousRate(double y, double anchorY, double anchorChartTime,
		double anchorRow);
	...
	/// <summary>
	/// Returns if the given region ends before the given EditorEvent.
	/// </summary>
	/// <param name="region">Region in question.</param>
	/// <param name="editorEvent">EditorEvent in question.</param>
	/// <returns>True if the region ends before the given EditorEvent and false otherwise.</returns>
...
internal sealed class EventSpacingHelperConstantTime : EventSpacingHelper
{
	...
	public override (double, double) GetChartTimeAndRowFromPreviousRate(double y, double anchorY, double anchorChartTime,
		double anchorRow)
	{
		// Determine the chart time based on a screen space delta and the pixels per second.
...
{
	protected EventSpacingHelperRow(EditorChart activeChart) : base(activeChart)
	{
	}
