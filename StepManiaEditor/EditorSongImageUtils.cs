...
namespace StepManiaEditor
{
	...
	internal sealed class EditorSongImageUtils
	{
		...
		{
			var fileNameNoExtension = System.IO.Path.GetFileNameWithoutExtension(filePath).ToLower();
		...
		public static SongImageType GetBestSongImageType(string imagePath)
		{
			try
			{
				var (fileNameNoExtension, extension) = GetFileNameAndExtension(imagePath);
