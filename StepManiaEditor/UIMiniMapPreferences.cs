		...
		public void Draw()
		{
			...
			if (ImGuiLayoutUtils.BeginTable("MiniMap Layout", 120))
			{
				...
				ImGuiLayoutUtils.DrawRowSliderUInt(true, "Note Width", p, nameof(PreferencesMiniMap.MiniMapNoteWidth), 1, 32,
					"%i pixels", ImGuiSliderFlags.None,
				...
				ImGuiLayoutUtils.DrawRowSliderUInt(true, "Note Spacing", p, nameof(PreferencesMiniMap.MiniMapNoteSpacing), 0,
					32, "%i pixels", ImGuiSliderFlags.None,
			...
			{
				ImGuiLayoutUtils.DrawRowEnum<Editor.SpacingMode>(true, "Variable Mode", p, nameof(PreferencesMiniMap.MiniMapSpacingModeForVariable), PreferencesMiniMap.MiniMapVariableSpacingModes,
					"The Spacing Mode the MiniMap should use when the Scroll Spacing Mode is Variable.");

				ImGuiLayoutUtils.DrawRowSliderUInt(true, "Constant Time Range", p, nameof(PreferencesMiniMap.MiniMapVisibleTimeRange), 30, 300,
					"%i seconds", ImGuiSliderFlags.Logarithmic,
					"The amount of time visible on the mini map when using Constant Time spacing.");

				ImGuiLayoutUtils.DrawRowSliderUInt(true, "Constant Row Range", p, nameof(PreferencesMiniMap.MiniMapVisibleRowRange), 3072, 28800,
