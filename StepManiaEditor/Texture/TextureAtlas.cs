...
public class TextureAtlas
{
	...
	public void AddTexture(string textureId, Texture2D texture, bool generateMipLevels)
	{
		...
		{
			Logger.Warn(
				$"Failed to pack texture \"{textureId}\" into TextureAtlas. A texture identified by \"{textureId}\" already exists.");
			return;
		}
		...
		Vector2 rotationOffset, float alpha, SpriteEffects spriteEffects)
	{
		...
		spriteBatch.Draw(Atlas, destinationRectangle, node.TextureRect, new Color(1.0f, 1.0f, 1.0f, alpha), rotation,
	...
	public void Draw(string textureId, SpriteBatch spriteBatch, Vector2 position, Vector2 origin, double scale, float rotation,
		float alpha, SpriteEffects spriteEffects)
	{
		...
		spriteBatch.Draw(Atlas, position, node.TextureRect, new Color(1.0f, 1.0f, 1.0f, alpha), rotation, origin, (float)scale,
			spriteEffects, 1.0f);
	}

	public void Draw(string textureId, SpriteBatch spriteBatch, Vector2 position, Vector2 origin, Color color, double scale,
	...
	public void Draw(string textureId, SpriteBatch spriteBatch, Rectangle sourceRectangle, Rectangle destinationRectangle,
		float rotation, float alpha, SpriteEffects spriteEffects)
	{
		...
		spriteBatch.Draw(Atlas, destinationRectangle, sourceRectangle, new Color(1.0f, 1.0f, 1.0f, alpha), rotation,
			rotationOffset, spriteEffects, 1.0f);
	}
		...
		SpriteEffects spriteEffects)
	{
		...
		spriteBatch.Draw(Atlas, position, node.TextureRect, new Color(1.0f, 1.0f, 1.0f, alpha), rotation, rotationOffset,
